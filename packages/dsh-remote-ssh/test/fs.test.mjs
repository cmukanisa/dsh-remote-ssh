...
import { RemoteRegistry } from '../lib/registry.js'
import { RemoteFileSystem } from '../lib/fs.js'
...
const { RemoteSubprocessRuntime } = await import('../lib/subprocess.js')
const subprocess = new RemoteSubprocessRuntime(ctx, {})
const { RemoteShellExecutor } = await import('../lib/shell.js')
